...
class SoundEngine:
    ...
    def __init__(self, sound_gpio: int, button_gpio: int, interrupt, should_stop: bool, volume: float):
        ...
        sound_driver = SingleBuzzerDriver(self._sound_logger, self._sound_gpio, self._volume)
